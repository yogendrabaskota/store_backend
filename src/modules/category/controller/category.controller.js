...
class CategoryController {
    async createCategory(req, res) {
        try {
            ...
            // Validation
            if (!name?.trim()) {
                return (0, helper_1.sendResponse)(res, 400, "Category name is required");
            }
            if (!description?.trim()) {
                return (0, helper_1.sendResponse)(res, 400, "Category description is required");
            }
            if (!userId) {
            ...
            if (existingCategory) {
                return (0, helper_1.sendResponse)(res, 409, "Category with this name already exists");
            }
            // Create new category
            ...
            return (0, helper_1.sendResponse)(res, 201, "Category created successfully", newCategory);
        }
        catch (error) {
    ...
    async getCategories(req, res) {
        try {
            ...
            return (0, helper_1.sendResponse)(res, 200, "Categories retrieved successfully", responseData);
        }
        catch (error) {
    ...
    async getCategoryById(req, res) {
        try {
            const { id } = req.params;
            if (!id) {
                return (0, helper_1.sendResponse)(res, 400, "Category ID is required");
            }
            ...
            if (!category) {
                return (0, helper_1.sendResponse)(res, 404, "Category not found");
            }
            return (0, helper_1.sendResponse)(res, 200, "Category retrieved successfully", category);
        }
        catch (error) {
    ...
    async updateCategory(req, res) {
        try {
            ...
            const userId = req.user?.id;
            if (!id) {
                return (0, helper_1.sendResponse)(res, 400, "id is required");
            }
            if (!userId) {
                return (0, helper_1.sendResponse)(res, 400, "Authentication required");
            }
            ...
            return (0, helper_1.sendResponse)(res, 200, "Category updated successfully", updatedCategory);
        }
        catch (error) {
    ...
    async deleteCategory(req, res) {
        try {
            ...
            const userId = req.user?.id;
            if (!id) {
                return (0, helper_1.sendResponse)(res, 400, "Id is missing");
            }
            if (!userId) {
                return (0, helper_1.sendResponse)(res, 400, "Authentication required");
            }
            // Check if category exists and has products
            const categoryWithProducts = await prisma_1.default.category.findUnique({
                where: { id },
                include: {
                    products: {
                        where: { isActive: true },
            ...
            if (categoryWithProducts.products.length > 0) {
                return (0, helper_1.sendResponse)(res, 400, "Cannot delete category with active products");
            }
            const categoryData = {
            ...
            return (0, helper_1.sendResponse)(res, 200, "Category deleted successfully");
        }
        catch (error) {
    ...
    async getCategoriesMinimal(req, res) {
        try {
            ...
            return (0, helper_1.sendResponse)(res, 200, "Categories retrieved successfully", categories);
        }
        catch (error) {
    ...
    async activateCategory(req, res) {
        try {
            ...
            if (typeof isActive !== "boolean") {
                return (0, helper_1.sendResponse)(res, 400, "isActive must be a boolean value");
            }
            ...
            if (existingCategory.isActive === isActive) {
                ...
                return (0, helper_1.sendResponse)(res, 200, message, {
            ...
            await (0, helper_1.createAuditLog)(userId, {
                ...
                description: `${isActive ? "Activated" : "Deactivated"} category: ${existingCategory.name}`,
                resource: "Category",
                resourceId: id,
            ...
            return (0, helper_1.sendResponse)(res, 200, message, updatedCategory);
        }
        catch (error) {
    ...
    async searchCategories(req, res) {
        try {
            const { q: searchQuery, page = 1, limit = 20, sortBy = "relevance", sortOrder = "desc", isActive, includeProducts = "false", } = req.query;
            ...
            const pageNum = Math.max(1, parseInt(page));
            const limitNum = Math.min(50, Math.max(1, parseInt(limit))); // More conservative limit for search
            const skip = (pageNum - 1) * limitNum;
    ...
    async generateSearchSuggestions(searchTerm) {
        try {
            ...
            const similarCategories = await prisma_1.default.category.findMany({
                where: {
                    OR: [
                        {
                            name: {
