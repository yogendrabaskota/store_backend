...
const inventory_controller_1 = __importDefault(require("../controller/inventory.controller"));
 ...
 */
router.post("/inventory/stock-in", auth_middleware_1.default.isAuthenticated, auth_middleware_1.default.isAdmin, // Restrict to ADMIN and SUPERADMIN
inventory_controller_1.default.stockIn);
/**
 ...
 */
router.post("/inventory/stock-out", auth_middleware_1.default.isAuthenticated, auth_middleware_1.default.isAdmin, // Restrict to ADMIN and SUPERADMIN
inventory_controller_1.default.stockOut);
/**
 ...
 */
router.post("/inventory/adjust", auth_middleware_1.default.isAuthenticated, auth_middleware_1.default.isAdmin, // Restrict to ADMIN and SUPERADMIN
inventory_controller_1.default.adjustStock);
/**
 ...
 */
router.get("/inventory/logs", auth_middleware_1.default.isAuthenticated, inventory_controller_1.default.getInventoryLogs);
/**
 ...
 */
router.get("/inventory/dashboard", auth_middleware_1.default.isAuthenticated, auth_middleware_1.default.isAdmin, // Restrict to ADMIN and SUPERADMIN
inventory_controller_1.default.getInventoryDashboard);
/**
 ...
 */
router.get("/inventory/product/:productId", auth_middleware_1.default.isAuthenticated, inventory_controller_1.default.getProductInventoryLogs);
/**
 ...
 */
router.get("/inventory/:logId", auth_middleware_1.default.isAuthenticated, inventory_controller_1.default.getInventoryLogById);
