 ...
 */
router.get("/dashboard/business", auth_middleware_1.default.isAuthenticated, auth_middleware_1.default.isAdmin, dashboard_controller_1.default.getBusinessDashboard);
