...
const sale_controller_1 = __importDefault(require("../controller/sale.controller"));
 ...
 */
router.post("/sales", auth_middleware_1.default.isAuthenticated, auth_middleware_1.default.restrictTo("STAFF", "ADMIN", "SUPERADMIN"), sale_controller_1.default.createSale);
/**
 * @route   GET /api/sales
 ...
 */
router.get("/sales", auth_middleware_1.default.isAuthenticated, sale_controller_1.default.getSales);
/**
 ...
 */
router.get("/sales/dashboard", auth_middleware_1.default.isAuthenticated, auth_middleware_1.default.isAdmin, sale_controller_1.default.getSalesDashboard);
/**
 ...
 */
router.get("/sales/search", auth_middleware_1.default.isAuthenticated, sale_controller_1.default.searchSales);
/**
 ...
 */
router.get("/sales/:id", auth_middleware_1.default.isAuthenticated, sale_controller_1.default.getSaleById);
/**
 ...
 */
router.patch("/sales/:id/status", auth_middleware_1.default.isAuthenticated, auth_middleware_1.default.isAdmin, sale_controller_1.default.updateSaleStatus);
